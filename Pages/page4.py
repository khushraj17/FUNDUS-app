...
location_df = pickle.load(open("data/pickle_files/location_df.pkl",'rb'))

cosine_sim1 = pickle.load(open("data/pickle_files/cosine_sim1.pkl",'rb'))
cosine_sim2 = pickle.load(open("data/pickle_files/cosine_sim2.pkl",'rb'))
cosine_sim3 = pickle.load(open("data/pickle_files/cosine_sim3.pkl",'rb'))
